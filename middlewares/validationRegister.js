...
const validationRegister = [ 
    ...
    .isLength({min:5, max:60}).withMessage("El apellido debe tener entre 5 y 60 caracteres"),
    ...
    .isStrongPassword([{minLength: 8, minLowercase: 1, minUppercase: 1, minNumbers: 1}]).withMessage("la contraseña debe contener un caracter en mayuscula, un numero y algun caracter en minuscula"),
